/**
 * This class is implemented by editor settings that are controlled by a checkbox.
 */
class EditorSettingControlCheckbox extends EditorSettingControl
{
	constructor(...args)
	{
		super(...args);
	...
	{
		let row = editorSettingControlManager.getNextRow("checkboxSettingFrame");
...
EditorSettingControlCheckbox.prototype.Checked =
	translate("Yes");

EditorSettingControlCheckbox.prototype.Unchecked =
	translate("No");
